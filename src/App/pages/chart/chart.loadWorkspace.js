agmNgModuleWrapper('agmp.chart')
    .defineController("p.chart.WorkspaceBaseController", ["pChartViewTemplateService", "coreUtil"],
    ...
    .defineControllerAsPopup('p.chart.LoadWorkspaceController', {
        ...
        function (vm, dep, tool) {
            tool.inheritVmController('p.chart.WorkspaceBaseController');
            vm.onSelectionApplied = function () {
                vm.uibClosePanel();
            }

        })
    .defineController("p.chart.WorkSpaceTableController", [],
        function (vm, dep, tool) {
            tool.inheritVmController('p.chart.WorkspaceBaseController');
