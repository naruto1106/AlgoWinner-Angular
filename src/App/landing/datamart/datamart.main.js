agmNgModuleWrapper("agm.landing")
    .defineControllerAsPage("agm.landing.DatamartController",
    "/App/landing/datamart/datamart.main.html",
    [],
    function (vm, dep, tool) {
        ...
        tool.onRendered(function () {
            ...
            //
            generator1 = new particleGenerator(0, H + 2, W, 0, 60);
            ...
            particle.prototype.update = function () {
                ...
                if (this.type2 === 0) {
                    drawTriangle(context, 0, 0, 15, 13, "#60f6ff");
                } else if (this.type2 === 1) {
                    drawCircle(context, 0, 0, 8, "#ffffff");

                } else if (this.type2 === 2) {
                    context.beginPath();
                    context.rect(0, 0, 13, 13);
                    context.closePath();
                    context.strokeStyle = "#00325f";
                    context.stroke();
                } else if (this.type2 === 3) {
                    drawCross(context, "#fff000");
                }
