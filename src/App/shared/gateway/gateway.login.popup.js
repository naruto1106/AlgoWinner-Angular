agmNgModuleWrapper('agms.gateway')
    .defineControllerAsPopup('s.gateway.LoginPopupController', {
        templateUrl: "/App/shared/gateway/gateway.login.popup.html",
        windowClass: 'default-modal'
    },
    ['sStrategyCommerceGuestService', 'sGatewayLoginService', 'sGatewayLoginState', 'showRegister', 'canDismiss', 'sUserAccountService',
