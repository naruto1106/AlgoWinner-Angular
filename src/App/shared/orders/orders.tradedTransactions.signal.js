agmNgModuleWrapper('agms.orders')
    .defineController('s.orders.TradedTransactionsSignalController', ['sTradingItemService', 'sTradingExchangeRateService', 'orderProcessing',
        ...
        function(vm, dep, tool) {
            ...
            tool.initialize(function () {
                tool.setVmProperties({
                    ...
                    noOrderMessage: "No order to display",
                    hasOrders: hasOrders,
