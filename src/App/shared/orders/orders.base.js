agmNgModuleWrapper('agms.orders')
    .defineController("s.orders.BaseController", ['sProductService','sOrdersClientService','sOrdersDetailService', 'filterFilter', 'orderByFilter', 'orderProcessing', 'sTradingItemService'],
        function (vm, dep, tool) {
            ...
            function hasOrders(orders, orderFilter) {
            ...
            tool.initialize(function () {
                tool.setVmProperties({
                    ...
                    noOrderMessage: vm.noOrderMessage || "No order to display",
                    hasOrders: hasOrders,
